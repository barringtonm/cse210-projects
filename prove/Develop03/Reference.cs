...
public class Reference
{
    ...
    private string _fileName = "Scriptfile.txt";
    private string _key;
    ...
    {
     //List<string> list = File.ReadAllLines(_fileName).Where(arg => !string.IsNullOrWhiteSpace(arg)).ToList();
        List<string> readText = list;
