...
class Program
{
    static void Main(string[] args)
    {
        ...
        WordInScripture wordInScripture = new WordInScripture();
        ...
        while (userChoice != 3)
        {
            ...
            switch (userChoice)
            {
                ...
                case 2:
                    ...
                    while (wordInScripture._hidden.Count < wordInScripture._result.Length)
                    {
                        wordInScripture.Show(ref1);
                        wordInScripture.GetReadKey();
                    }
                    wordInScripture.Show(ref1);
                    break;
                case 3:
